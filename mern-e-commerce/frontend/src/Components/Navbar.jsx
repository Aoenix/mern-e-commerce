...
export default function PrimarySearchAppBar() {
  ...
  const handleBecomeSeller = () => {
    if ( ( userDet ) && ( userDet.type !== "" ) && (userDet.type === "seller" || userDet.type === "admin")) {
      setAnchorEl(null);
      navigate("/dashboard");
    } else {
  ...
  const renderMenu = (
    ...
    >
      ...
      <MenuItem onClick={handleBecomeSeller}>
        {( ( userDet ) && ( userDet.type !== "" ) && (userDet.type === "seller" || userDet.type === "admin") )? "Admin Dashboard" : "Become a seller"}
      </MenuItem>
