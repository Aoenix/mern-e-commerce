      ...
      >
        <Stack direction="column">
          ...
          <Typography variant="body2" paragraph maxWidth={300}>
            Mern E-Shop is a full stack web app developed by our team, offering
        ...
        <Stack>
          ...
          <Stack spacing={2} direction="column">
            <Stack spacing={2} direction="row">
              <FmdGoodRoundedIcon />
              <Typography paragraph>Delhi, India</Typography>
            </Stack>
            <Stack spacing={2} direction="row">
              <CallRoundedIcon />
              <Typography paragraph>+91 1111111111</Typography>
            </Stack>
            <Stack spacing={2} direction="row">
              <MailRoundedIcon />
              <Typography paragraph>merneshop@gmail.com</Typography>
            </Stack>
          </Stack>
        </Stack>
      </Stack>
